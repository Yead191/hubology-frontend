...
import { Settings, RefreshCw, CheckCircle, ShieldAlert, Award, Trophy, Users, Eye, HelpCircle, FileCheck } from "lucide-react";
...
function IFundAyitiContent() {
  ...
  return (
    <div className="relative min-h-screen bg-ink text-cloud">
      ...
      {/* Status Lookup (Moved up from the bottom of the page) */}
      ...
      {/* Senior Developer Flow Simulator Control Panel (Sticky at bottom right) */}
      <div className="fixed bottom-6 right-6 z-90 max-w-sm sm:max-w-md print:hidden">
        <div className={`border-gradient rounded-3xl bg-panel-soft/95 backdrop-blur-md shadow-2xl transition-all duration-300 border-hairline-strong ${
          simOpen ? "p-6 max-h-[70vh] w-80 sm:w-96 overflow-y-auto" : "p-3 h-auto"
        }`}>
          {/* Header */}
