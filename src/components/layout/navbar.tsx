  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center pt-4 pr-(--removed-body-scroll-bar-size)">
      <div className="max-w-6xl w-full px-4 lg:px-6">
        ...
        <div
          className={cn(
            "fixed inset-x-4 top-21 z-40 origin-top rounded-3xl border border-hairline-strong glass backdrop-blur-2xl p-4 transition-all duration-300 ease-out-soft lg:hidden",
            mobileOpen
