...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4 pt-4">
      <nav
        className={cn(
          "flex w-full max-w-6xl items-center justify-between gap-4 rounded-full border border-hairline px-3 py-2.5 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]",
          scrolled
            ? "glass border-hairline-strong shadow-[0_8px_40px_-12px_rgba(0,0,0,0.6)]"
